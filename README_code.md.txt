...
حتماً. اگر ریپو را روی دسکتاپ clone کردی و تغییراتت را انجام دادی، برای فرستادن تغییرات به GitHub معمولاً این مراحل را انجام بده:
...
2. ببین چه فایل‌هایی تغییر کرده‌اند
git status
3. تغییرات را به Git اضافه کن
