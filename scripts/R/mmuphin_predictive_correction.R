...
if (length(args) != 6) {
    ...
    stop(
        paste(
            "Usage: Rscript mmuphin_predictive_correction.R",
            "<feature_table>",
            "<metadata>",
            "<batch_variable>",
            "<adjusted_output>",
...
summary_table <- data.frame(
    ...
    Primary_Predictive_Analysis =
        FALSE,

    Uses_All_Input_Samples_For_Harmonization =
        TRUE,

    Unseen_Study_Inductive =
        FALSE,
