# NOTE:
# The nested CV splitting and feature selection are fold-safe,
# but the upstream MMUPHin matrix was harmonized globally.
#
# Therefore this corrected branch is reported only as
# transductive sensitivity analysis, not as primary
# unseen-study predictive validation.
